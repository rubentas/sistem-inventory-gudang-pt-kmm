        ...
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p class="text-sm text-gray-400 mt-0.5">
              Mengelola master data supplier/pemasok
            </p>
          </div>
        </div>
        ...
        <thead>
          <tr class="bg-gray-50 border-b border-gray-100">
            ...
            <th class="px-5 py-4 text-left">
              <span class="text-xs font-bold text-gray-400 uppercase tracking-wider">Kode</span>
            </th>
            ...
            <tr class="hover:bg-blue-50/30 transition">
              ...
              <td class="px-5 py-4">
                ...
                <div class="flex items-center justify-center gap-0.5">
                  ...
                  {{-- EDIT --}}
                  <button
                    wire:click="edit({{ $supplier->id_supplier }})"
                ...
                <div class="flex flex-col items-center text-center gap-5 max-w-sm mx-auto">
                  ...
                  <div>
                    ...
                    <p class="text-sm text-gray-400">
                      Belum ada data supplier yang tercatat.
                    </p>
                  </div>
      ...
      <div
            ...
            <div class="flex items-center gap-3">
              ...
              <div class="text-white">
                ...
                <h2
                  ...
                  x-text="$wire.isEdit ? 'Edit Supplier' : 'Tambah Supplier'">
                </h2>

                <p class="text-blue-100 text-xs">
                  Lengkapi field wajib <span class="text-white">*</span>
                </p>
        ...
        <div class="px-6 py-4 border-t border-gray-100 bg-gray-50 flex items-center justify-between gap-3">
          ...
          <div class="flex items-center gap-2">
            ...
            <button
              @click="$wire.isEdit ? $wire.update() : $wire.simpan()"
