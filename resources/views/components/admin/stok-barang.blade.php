<div class="space-y-5">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-5 hover:shadow-md transition">
      ...
      <p class="text-xs text-gray-400 mt-3">Seluruh barang (dalam satuan)</p>
    </div>
    ...
    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-5 hover:shadow-md transition">
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="text-2xl font-extrabold text-red-600">{{ number_format($stats['menipis']) }}</p>
        </div>
      </div>
    ...
    <div class="bg-white border border-gray-200 rounded-2xl shadow-sm p-5 hover:shadow-md transition">
      <div class="flex items-center gap-4">
        ...
        <div>
          ...
          <p class="text-2xl font-extrabold text-emerald-600">{{ number_format($stats['aman']) }}</p>
        </div>
      </div>
        ...
        <tbody class="divide-y divide-gray-50">
          @forelse($stoks as $index => $stok)
            <tr class="hover:bg-blue-50/30 transition">
              ...
              <td class="px-5 py-4">
                <span
                  class="px-2.5 py-1 bg-indigo-50 text-indigo-700 border border-indigo-100 rounded-lg text-xs font-semibold">{{ $stok->barang->kategori ?? '-' }}</span>
              </td>
