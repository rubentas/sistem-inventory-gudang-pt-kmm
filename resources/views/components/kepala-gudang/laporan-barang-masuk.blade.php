      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3">
        <div>
          ...
          <input type="text" wire:model.live.debounce.300ms="search" placeholder="Cari barang, nota..."
            class="w-full rounded-xl border-2 border-gray-200 px-4 py-2.5 text-sm font-medium bg-gray-50 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition outline-none">
        </div>
        <div>
          ...
          <select wire:model.live="filterSumber"
            class="w-full rounded-xl border-2 border-gray-200 px-4 py-2.5 text-sm font-semibold bg-gray-50 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-100 transition outline-none cursor-pointer">
        ...
        <tbody class="divide-y divide-gray-50">
          @forelse($barangMasuk as $item)
            <tr class="hover:bg-blue-50/30 transition">
              ...
              <td class="px-5 py-4"><span
                  class="px-2.5 py-1 bg-indigo-50 text-indigo-700 border border-indigo-100 rounded-lg text-xs font-semibold">{{ $item->sumber }}</span>
              </td>
