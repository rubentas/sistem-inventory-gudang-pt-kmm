<div>
  <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
    <div>
      ...
      <p class="text-gray-500 text-sm">Memantau stok barang secara real-time</p>
    </div>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
    <div class="bg-white rounded-lg shadow p-4 border-l-4 border-blue-500">
      ...
      <p class="text-xs text-gray-400 mt-1">Seluruh barang</p>
    </div>
            ...
            <tr class="hover:bg-gray-50">
              ...
              <td class="px-4 py-3 text-sm">
                @if ($stok->status == 'Menipis')
                  <span class="px-2 py-1 bg-red-100 text-red-800 rounded-full text-xs font-semibold">Menipis</span>
                @else
                  <span class="px-2 py-1 bg-green-100 text-green-800 rounded-full text-xs font-semibold">Aman</span>
                @endif
              </td>
            </tr>
          @empty
            <tr>
              <td colspan="8" class="px-4 py-8 text-center text-gray-500">Tidak ada data stok</td>
            </tr>
          @endforelse
        </tbody>
      </table>
