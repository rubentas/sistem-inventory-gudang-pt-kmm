<div>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
    <div class="bg-white rounded-lg shadow p-5 border-l-4 border-blue-500">
      <p class="text-gray-500 text-sm">Barang Masuk (Bulan Ini)</p>
      <p class="text-2xl font-bold text-gray-800">{{ number_format($totalMasukBulanIni) }}</p>
      <p class="text-xs text-gray-400 mt-1">Total barang masuk</p>
    </div>

    <div class="bg-white rounded-lg shadow p-5 border-l-4 border-red-500">
      <p class="text-gray-500 text-sm">Barang Keluar (Bulan Ini)</p>
      <p class="text-2xl font-bold text-gray-800">{{ number_format($totalKeluarBulanIni) }}</p>
      <p class="text-xs text-gray-400 mt-1">Total barang keluar</p>
    </div>
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full">
          ...
          <tbody class="divide-y divide-gray-200">
            ...
            @empty
              <tr>
                <td colspan="4" class="px-5 py-8 text-center text-gray-500">Belum ada数据</td>
              </tr>
            @endforelse
          </tbody>
        </table>
